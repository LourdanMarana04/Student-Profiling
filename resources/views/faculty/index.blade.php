<x-app-layout>
    <style>
        ...
        .status-badge.on_leave { background: #f8d7da; color: #721c24; }
    ...
    <div class="card-header">
        <div>
            ...
            <p class="page-subtitle">Manage and view all faculty information</p>
        </div>
        <a href="{{ route('faculty.create') }}" class="btn-primary">+ Add New Faculty</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-links">
                                <a href="{{ route('faculty.show', $member) }}">View</a>
                                <a href="{{ route('faculty.edit', $member) }}">Edit</a>
                                <form method="POST" action="{{ route('faculty.destroy', $member) }}" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this faculty member?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 3rem;">
                            <div class="empty-state">
                                ...
                                <p class="empty-state-text">No faculty members found. <a href="{{ route('faculty.create') }}" style="color: #5b5bee; text-decoration: none; font-weight: 600;">Create one now</a></p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
