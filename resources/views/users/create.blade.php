<x-app-layout>
    ...
    <div class="page-hero">
        ...
        <p class="page-copy">Add a new system user for admin or staff access. Student and faculty accounts continue to be created from their dedicated modules.</p>
    </div>
    ...
    <div class="form-shell">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <p class="helper-note">This screen is for direct system accounts only.</p>
